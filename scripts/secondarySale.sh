...
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to JQ3QOVBYDKSMZA42HB3DCWJWS4L6KR7ZMFUG5IYECEAM4WE3PP74GG6ZNM --amount 200000 --out unsignedSend1.tx
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to HGIMASMUMZAI5SCNOYR65TIQM4JWLE736FERTFPCPUNZSQRXK42Q5VMNMQ --amount 200000 --out unsignedSend2.tx
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to 5EP6AOHJBRLL7G2W74Q6NNOZOUCDT6F35ZRXSNTU4UHTHWDZVTDOAYTFAE --amount 200000 --out unsignedSend3.tx
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to JUDGEZENUFSP3UGRQLGN7Q5QE4V3YIYQNZ76SI7Z7IXMKBYMK2JAJE4PWU --amount 200000 --out unsignedSend4.tx
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to DHTJB4G5KZI3H3AUBFMREUPPLQJMLG65NOREYDLUYUPVKTKJPQM5WF2WNA --amount 200000 --out unsignedSend5.tx
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to 3BHZPTXX6Q3GRS7URKAXSO7BT36HI2NLV4SLSUDTSFKMIH56NPZKK7HKUU --amount 200000 --out unsignedSend6.tx
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to WELR5BBI456XXE4GOVX4FK3GE2T2PA3LJ3VTPY7RHPDCL5H3CIXKUWNGS4 --amount 200000 --out unsignedSend7.tx
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to QQX5Y647GO7VLG33ZQWKEHO2OPXPVCEY7QNNE2AK2AVA4HYFFD4MJNFYFM --amount 200000 --out unsignedSend8.tx
goal clerk send --from ODF7YUAT4JMWSQLH3CXE5XUBLCHIZAWJTR3I3SDAASAGVQ3AWZ7SYWCBSE --to VTAUB5LOVTWKXICWEDBO5UG2JNNGEW7ULRB4PQB23DGRKSAXDVPORQNZJE --amount 200000 --out unsignedSend9.tx
